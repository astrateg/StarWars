...
namespace StarWars.Models
{
	public class Ship
	{
		...
		public void Shoot() {
            ...
            var active = this.WeaponActive;
			if (this.MP > Bomb.Types.MP[active]) {
                double speed = Bomb.Types.Speed[active] + this.Speed;
                Bomb bomb = new Bomb("ranger", bombX, bombY, this.Angle, Bomb.Types.Size[active], speed, active);
				this.Bombs.Add(bomb);
